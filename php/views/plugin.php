...
<html>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Plugin (<?=$_GET["slug"];?>)</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <!-- Main row -->
                    <div class="row">
                       	<?=$ControlPanel->pluginInfo($_GET['slug']);?>
                    </div><!-- /.row (main row) -->
        ...
        <script>
		$("#pluginForm").ajaxForm();
		$("#pluginGO").click(function() {
			var clientServer = $("#clientserver").val();
			var pluginVersion = $("#pluginversion").val();
			var slug = $("#slug").val();
			$.post("/php/plugins/installPlugin/installPlugin.php", {clientServer: clientServer, slug: slug, pluginVersion: pluginVersion}, function(data){
				alert(data);
			});
		});
	</script>
