...
<div class="navbar navbar-default" id="subnav">
    <div class="col-md-12">
        <div class="navbar-header">
          ...
          <a href="." style="margin-left:15px;" class="navbar-btn btn btn-default btn-plus dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-cog" style="color:#dd1111;"></i> Settings <small><i class="glyphicon glyphicon-chevron-down"></i></small></a>
...
<div class="container" id="main">
   ...
   <div class="col-md-6 col-sm-6">
        <div class="panel panel-default">
          <div class="panel-heading"><h4>Currently Deployed</h4></div>
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="col-md-12 text-center">
            ...
            <br><br>
            <a href="https://github.com/iatek/bootstrap-google-plus">
	            VAR: 1 <?=$_GET['p'];?>
	            VAR: 2 <?=$_GET['id'];?>
            </a>
          </div>
